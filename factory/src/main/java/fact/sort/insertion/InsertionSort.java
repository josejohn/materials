...
public class InsertionSort {
	public static void main(String args[]) {
		...
		System.out.println("Random Integer array before Sorting : "
				+ Arrays.toString(randomOrder)); // sorting array using
													// insertion sort in Java
		insertionSort(randomOrder);
		System.out.println("Sorted array uisng insretion sort : "
				+ Arrays.toString(randomOrder)); // one more example of sorting
													// array using insertion
													// sort
		randomOrder = getRandomArray(7);
		System.out.println("Before Sorting : " + Arrays.toString(randomOrder));
		insertionSort(randomOrder);
		System.out.println("After Sorting : " + Arrays.toString(randomOrder)); // Sorting
																				// String
																				// array
																				// using
																				// Insertion
	...
	public static void insertionSort(int[] array) { // insertion sort starts
													// from second element
		for (int i = 1; i < array.length; i++) {
			int numberToInsert = array[i];
			int compareIndex = i;
			while (compareIndex > 0 && array[compareIndex - 1] > numberToInsert) {
				array[compareIndex] = array[compareIndex - 1]; // shifting
																// element
	...
	public static void insertionSort(Comparable[] objArray) { // insertion sort
																// starts from
																// second
																// element
