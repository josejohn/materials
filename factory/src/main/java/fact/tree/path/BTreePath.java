...
class BTreePath
{
    ...
    void printPathsRecur(Node node, int path[], int pathLen, int value)
    {
        if (node == null)
            return;
...
//        if (node.left == null && node.right == null)
        ...
        else
        {
            ...
            printPathsRecur(node.left, path, pathLen, value);
            printPathsRecur(node.right, path, pathLen, value);
        }
    }
